...
static unsigned long long Aleatoire64(void)
{
	unsigned long long random1 = Aleatoire();
	unsigned long long random2 = Aleatoire();

	random1 = random2 << 32 | random2;
...
void makenullmove()
{
	/* take back move if in check */
	side ^= 1;
	xside ^= 1;
	
	hist_dat[hply].capture = 0;
	hist_dat[hply].castle = castle;
	hist_dat[hply].ep = ep;
	hist_dat[hply].fifty = fifty;
	hist_dat[hply].hash = hash;
	//hist_dat[ply].captureBoard = 0;
	//hist_dat[ply].captureEp = 0;
	hist_dat[ply].m.b.bits= 0;
	hist_dat[ply].m.b.from = 0;
	hist_dat[ply].m.b.to = 0;
	hist_dat[ply].m.b.promote = 0;
	++ply;
	++hply;
}
